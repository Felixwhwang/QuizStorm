...
<main id="main" class="main <?php mf_container_class();?>" role="main">
    ...
    <div class="row">
        ...
        <div class="<?php echo esc_attr( exc_kv( $layout, 'content_width', 'col-md-6' ) );?> main-content">
            ...
            <?php
            $post_type = ( $type = get_query_var('post_type') ) ? $type : exc_kv( $layout, 'post_type', array( 'post', 'exc_audio_post', 'exc_video_post', 'exc_image_post' ) );
            $query = array_merge( $GLOBALS['wp_query']->query_vars,
                                        array(
