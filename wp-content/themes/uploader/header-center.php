...
<head>
    ...
    <?php
    // note: The custom javascripts and stylesheets files are being included from inc/scripts_styles.php    
    wp_head(); ?>
</head>
...
<div class="wrapper <?php echo ( $is_boxed_view ) ? 'container' : '';?>">
        ...
        <!-- Top Bar -->
        <?php if ( exc_kv( $header_settings, 'hc_topbar_status' ) == 'on' ) :?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ul class="exc-contact-info">
                            <?php if ( $email_addr = exc_kv( $header_settings, 'hc_topbar_email_addr' ) ) :?>
                                <li><i class="fa fa-envelope-o"></i><?php echo $email_addr;?></li>
                            <?php endif;?>

                            <?php if ( $phone_no = exc_kv( $header_settings, 'hc_topbar_phone' ) ) :?>
                                <li><i class="fa fa-phone"></i><?php echo $phone_no;?></li>
                            <?php endif;?>
                        </ul>
                    </div>

                    <?php if ( exc_kv( $header_settings, 'hc_topbar_social_icons' ) ) :?>
                    <div class="col-sm-6">
        ...
        <div class="header-bottom">
            ...
            <div class="logo-bar">
                <div class="<?php mf_container_class();?>">
                    ...
                    <!-- Main Menu -->
                    <?php if ( exc_kv( $header_settings, 'hc_menu_status' ) == 'on' ) :?>
